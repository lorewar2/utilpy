...
STIEG_UNIQUE_LOC = "./intermediate/hera_unique.fa.ktab"
K = 40
...
def main():
    ...
    util.find_which_parent_contain_kstring(k_string_vec, haplotype_allele_vec, ref_loc_vec, phase_blocks, TABEX_LOC, INTERMEDIATE_LOC, [HERA_UNIQUE_LOC, STIEG_UNIQUE_LOC])
    return
